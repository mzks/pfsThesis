...
また,ポジトロニウムの生成された時刻を求めるためには,\ce{^{22}Na}の崩壊によって生じる1275keVの$\gamma$線を用いる.上方に設置してシンチレータSにこの$\gamma$線が入射し,検出された場合にポジトロニウムの生成時刻を知ることができる.
%一気に3行2列で配置する方
%\begin{figure}[H]
%	\begin{minipage}{0.5\hsize}
%		\centering
...
第\ref{SCtrig}で議論するように,プラスチックシンチレータを用いることで\ce{^{22}Na}の崩壊で放出される陽電子を直接トリガーとして利用できる.
